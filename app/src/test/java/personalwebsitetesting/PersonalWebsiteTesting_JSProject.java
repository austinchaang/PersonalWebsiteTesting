...
//     // WT-J1: HTTP 200 status code for the JS Project page
...
//     //WT-J3: Testing projects URL link
...
//     //WT-J4: Testing interests URL link
...
//     //WT-J5: Testing header after player x's turn
...
//     //WT-J6: Testing header after player o's turn
...
//     //WT-J7: Left vertical column player x win
...
//     //WT-J8: Center vertical column player o win
...
//     //WT-J9: Right vertical column player x win
...
//     //WT-J10: Top horizontal row player o win
...
//     //WT-J11: Middle horizontal row player x win
...
//     //WT-J12: Bottom horizontal row player o win
...
//     //WT-J13: Top left to bottom right diagonal player x win
...
//     //WT-J14: Top right to bottom left diagonal player o win
...
//     //WT-J15: Repeated press of buttons test 1 
//     @Test public void repeatPressTest() {
//         wait.until(ExpectedConditions.elementToBeClickable(jsProject.getTopLeft()));
//         // Player x turn
//         jsExecutor.executeScript("arguments[0].scrollIntoView(true);", middleRight);
//         jsExecutor.executeScript("arguments[0].click();", middleRight);
...
//     //WT-J16: Repeated press of buttons test 2
//     @Test public void repeatPressTest2() {
//         wait.until(ExpectedConditions.elementToBeClickable(jsProject.getTopLeft()));
//         // Player x turn
//         jsExecutor.executeScript("arguments[0].scrollIntoView(true);", middleCenter);
//         jsExecutor.executeScript("arguments[0].click();", middleCenter);
...
//         jsExecutor.executeScript("arguments[0].scrollIntoView(true);", topCenter);
//         jsExecutor.executeScript("arguments[0].click();", topCenter);
//         Assert.assertTrue(driver.findElement(jsProject.getHeader()).getText().contains("It's a tie!"));
//     } 
// }